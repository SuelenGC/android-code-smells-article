...
\begin{subfigure}{.22\textwidth}
  \centering
  \includegraphics[width=.98\textwidth]{plot-lcui.jpg}
  \caption{\textsc{LCUI}}
  \label{fig:lcui}
\end{subfigure}%
\begin{subfigure}{.17\textwidth}
  \centering
  \includegraphics[width=.85\textwidth]{plot-recursos.jpg}
  \caption{\textsc{Recursos}}
  \label{fig:resources}
\end{subfigure}%
\begin{subfigure}{.17\textwidth}
  \centering
  \includegraphics[width=.85\textwidth]{plot-lpa.jpg}
  \caption{\textsc{LPA}}
  \label{fig:lpa}
\end{subfigure}% 
\begin{subfigure}{.17\textwidth}
  \centering
  \includegraphics[width=.85\textwidth]{plot-rm.jpg}
  \caption{\textsc{RM}}
  \label{fig:rm}
\end{subfigure}
\begin{subfigure}{.17\textwidth}
  \centering
  \includegraphics[width=.85\textwidth]{plot-nrd.jpg}
  \caption{\textsc{NRD}}
  \label{fig:nrd}
\end{subfigure}% 
