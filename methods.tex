% -*- root: article.tex -*-
O \emph{objetivo} deste estudo é investigar boas e más práticas no desenvolvimento do \textit{front-end} Android. Portanto, conduzimos um estudo qualitativo e exploratório no qual coletamos dados através de questionário online e experimento controlado com desenvoveldores Android. \mau{defenda aqui o uso de estudos qualitativos, veja como Michaela Greiler fez 'test confessions'}

Para responder a Q1, buscamos entender o que desenvolvedores consideram boas e más práticas no desenvolvimento do \textit{front-end} Android, os dados foram coletados através de um questionário online aplicados a 45 desenvolvedores. Realizamos um processo de codificação aberto sobre os dados, resultando num conjunto com 23 categorias de boas e más práticas Android. Estas categorias foram agrupadas de acordo com sua recorrência nas respostas, ou seja, a quantidade de respostas que determinada categoria é percebidas, quanto mais respostas, maior a recorrência.

Para responder a Q2, buscamos entender a percepção dos desenvolvedores sobre as quatro boas e más práticas classificadas com alta recorrência, estes dados foram obtidos através de um experimento com 11 desenvolvedores. Extraísmos dados estattísticos que nos mostram que de fato, as más práticas são percebidas pelos desenvolvedores como indícios de códigos problemáticos.
