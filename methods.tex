...
\begin{itemize} 
	\item Voc\^e tem alguma boa pr\'atica para lidar com Activities?
	\item Voc\^e considera alguma coisa uma m\'a pr\'atica ao lidar com Activities? 
\end{itemize}
...
O question\'ario esteve aberto por aproximadamente 3 meses e meio, de 9 de Outubro de 2016 at\'e 18 de Janeiro de 2017. Recebemos um total de 45 respostas. 
...
\mau{na tabela de dados demográficos, tem muito espaço entre as linhas}

\subsection{An\'alise dos Dados}
\label{sub:smells-definition}

O processo de an\'alise partiu da listagem das 45 respostas do question\'ario e se deu em 4 passos: verticaliza\c{c}\~ao, limpeza dos dados, codifica\c{c}\~ao e divis\~ao. \mau{encaixar o processo de análise com alguma literatura sobre o assunto, veja como a michaela também fez no paper dela ou meu paper no MSR desse ano (está no meu site).}
