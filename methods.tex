% -*- root: article.tex -*-
O \emph{objetivo} deste estudo é \textcolor{red}{bla bla bla}. Portanto, conduzimos um estudo qualitativo e exploratório no qual os dados foram coletados através de um questionário online com desenvoveldores Android. \mau{defenda aqui o uso de estudos qualitativos, veja como Michaela Greiler fez 'test confessions'}

\mau{explicar em alto nível, 2 ou 3 frases, a metodologia aqui.} Esta seção descreve de forma detalhada a estrutura do questionário, os participantes e a análise realizada sobre as respostas obtidas.
