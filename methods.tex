...
A primeira seção foi composta por questões cujo objetivo era traçar o perfil demográfico do participante (idade, estado de residência, experiência em desenvolvimento de software e em desenvolvimento Android).
...
\begin{subfigure}{.5\textwidth}
 \centering
 \includegraphics[width=.95\linewidth]{s1.jpeg}
 \caption{\textit{S1}}
 \label{fig:sub1}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
 \centering
 \includegraphics[width=.95\linewidth]{s2.jpeg}
 \caption{\textit{S2}}
 \label{fig:sub2}
\end{subfigure}
...
\mau{colocar figura 1 e 2 na mesma linha, ou diminuir de outro jeito. tá ocupando muito espaço desnecessariamente.}
