...
% As perguntas sobre boas e m\'as pr\'aticas foram as a seguir: 
% \begin{itemize} 
% 	\item[$\textasteriskcentered$] Existem outras *BOAS* pr\'aticas sobre a Camada de Apresenta\c{c}\~ao Android que n\'os n\~ao perguntamos ou que voc\^e n\~ao disse ainda?
% 	\item[$\textasteriskcentered$] Existem outras *M\'AS* pr\'aticas sobre a Camada de Apresenta\c{c}\~ao Android que n\'os n\~ao perguntamos ou que voc\^e n\~ao disse ainda?
% \end{itemize}
